...
function MobMenu({ active, setActive }) {
  return (
    <div className="relative h-full w-full py-6 px-3 border-b-[1px] border-b-gray-300 flex flex-col gap-y-6 justify-normal">
      ...
      <div className="absolute top-0 right-0 py-6 px-3 border-l-[1px] border-l-gray-300 bg-white w-[65%] md:w-[50%]">
